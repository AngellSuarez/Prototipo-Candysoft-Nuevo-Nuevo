...
const GestionHorarios = () => {
    ...
    const [horarios, setHorarios] = useState([
        { id: 1, manicurista: "Sofia Perez", fecha: "2025-03-20", horaEntrada: "08:00", horaSalida: "16:00", motivo: "Turno regular", estado: false },
        { id: 2, manicurista: "Carla Muñoz", fecha: "2025-03-21", horaEntrada: "11:00", horaSalida: "18:00", motivo: "Horario flexible", estado: true },
        { id: 3, manicurista: "Monica Sanchez", fecha: "2025-03-28", horaEntrada: "12:00", horaSalida: "18:00", motivo: "Horario flexible", estado: true },
    ]);
    ...
    return (
        <div className={`roles-container ${darkMode ? "dark" : ""}`}>
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold">Gestión de novedades</h1>
            </div>
                                        ...
                                        <div className="fila-formulario">
                                            <div className="campo">
                                                ...
                                                >
                                                    ...
                                                    <option value="Sofia Perez">Sofia Pérez</option>
                                                    <option value="Monica Sanchez">Mónica Sánchez</option>
                                                    <option value="Carla Munoz">Carla Muñoz</option>
                                                </select>
