...
const GestionReporteMan = () => {

    const [reportes, setReportes] = useState([
        { id: 1, manicurista: "Paula González", fecha: "12/03/2025" },
        { id: 2, manicurista: "Paula González", fecha: "11/02/2025" },
        { id: 3, manicurista: "Paula González", fecha: "23/03/2025" },
    ]);
    ...
    const handleEliminarReporte = (reporte) => {
        MySwal.fire({
            ...
            html: `
                                <p class="texto-blanco">¿Estás seguro de que deseas anular el consumo de  <strong>${reporte.manicurista}</strong> en la fecha <strong>${reporte.fecha}?</p>
                                `,
            icon: 'warning',
    ...
    const handleCrearReporte = () => {
        ...
        const manicuristaSeleccionada = manicuristas.find(m => m.id === Number(selectedManicurista));

        if (!manicuristaSeleccionada) {
            alert("Debes seleccionar una manicurista válida");
            return;
        }

        const nuevoReporte = {
            id: reportes.length + 1,
            manicurista: manicuristaSeleccionada.nombre,
            fecha: selectedDate,
            estado: true
        };
    ...
    const manicuristas = [
        {
            ...
            abastecimientos: [
                { fecha: "2025-04-09", insumos: ["Esmalte rojo", "Algodón"] },
                { fecha: "2025-04-10", insumos: ["Esmalte azul", "Removedor"] },
            ],
        },
    ];
    ...
    return (
        <div className={`roles-container ${darkMode ? "dark" : ""}`}>
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold">Gestión de consumos</h1>
            </div>
...
export default GestionReporteMan;